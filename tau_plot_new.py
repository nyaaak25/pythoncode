...
# 波数
# v_txt = np.loadtxt('/Users/nyonn/Desktop/pythoncode/not use file/test1_rad.dat')
v_txt = np.loadtxt(
    '/Users/nyonn/Desktop/pythoncode/Tau_file/LUtable_1_tau.txt')
v1 = v_txt[:, 0]
cm_v = (1/v1)*10000
v = cm_v[::-1]
...
tau_txt = np.loadtxt(
    '/Users/nyonn/Desktop/pythoncode/not use file/test1_trans_mono.dat')
cut120_1 = tau_txt[:, 1]
cut120 = cut120_1[::-1]
# sza_theta = 18.986036
sza_theta = 0
...
tau_txt1 = np.loadtxt(
     '/Users/nyonn/Desktop/pythoncode/Tau_file/LUtable_1_tau.txt')
# tau_txt1 = np.loadtxt('/Users/nyonn/Desktop/pythoncode/not use file/test1_rad.dat')
cut12_1 = tau_txt1[:, 1]
cut12 = cut12_1[::-1]
I0 = np.exp(-cut12/np.cos(sza_theta))
Iobs = I0 * np.exp(-cut12)
...
ax.plot(v, cut120, color='red', label="ARSM Calc", zorder=2, lw=0.1)
ax.plot(v, Iobs, color='blue', label="My Calc", zorder=1, lw=0.1)
