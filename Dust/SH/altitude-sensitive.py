...
# とりあえずでてきたものをplotしてみる
# ------- set a parameter -------
filename = "277"  # 波長+何倍かを示している。1なら等倍、2なら10倍, 3なら100倍
Dust_list = ["0.175", "1.75", "18.5"]
...
for loop in range(1, 4, 1):
    ORG_base = np.loadtxt("/Users/nyonn/Desktop/pythoncode/Dust/SH/data-altitude/output/org/"+filename+"_"+str(loop)+ "d_rad.dat")
    ORG_wave = ORG_base[0]
    ORG_wav = 1 / ORG_wave
    ...
    # Baseの高度をここに入れる
    HD_base = np.loadtxt("/Users/nyonn/Desktop/pythoncode/Dust/SH/data-altitude/input/input-hc/" +filename+"_"+str(loop)+ "d.hc")
    altitude = HD_base[:,0]
    orginal = HD_base[:,1]
    ...
    for i in range(0,60,1):
        HD = np.loadtxt("/Users/nyonn/Desktop/pythoncode/Dust/SH/data-altitude/output/"+filename+ "_" +str(loop)+ "d/" + str(i) + "_rad.dat")
        rad = HD[1]
    ...
    #ax.scatter(new_opacity, altitude, label=Dust_list[loop-1])
    ax.scatter(normarize, altitude, label=Dust_list[loop-1],s=10)
...
for loop in range(0, 3, 1):
    ...
    # baseの高度をここに入れる
    HD_base_con1 = np.loadtxt("/Users/nyonn/Desktop/pythoncode/Dust/SH/data-altitude/input_hc/" +str(loop+1)+ "dd_before.hc")
    orginal_con1 = HD_base_con1[:,1]

    # 2.2 μmの暫定的な結果を出力するためのプログラム
    ORG_base_con2 = np.loadtxt("/Users/nyonn/Desktop/pythoncode/Dust/SH/data-altitude/output/ORG/After_ORG_DD" +str(loop)+ "_rad.dat")
    ...
    # baseの高度をここに入れる
    HD_base_con2 = np.loadtxt("/Users/nyonn/Desktop/pythoncode/Dust/SH/data-altitude/input_hc/" +str(loop+1)+ "dd_after.hc")
    ...
    for i in range(0,60,1):
        ref2_cont = 0
        HD = np.loadtxt("/Users/nyonn/Desktop/pythoncode/Dust/SH/data-altitude/output/DD" +str(loop)+ "/" + str(i) + "_rad.dat")
        rad = HD[1]
        rad_1 = (rad / (ORG_wav**2)) * 1e-7

        HD_2 = np.loadtxt("/Users/nyonn/Desktop/pythoncode/Dust/SH/data-altitude/output/DD" +str(loop)+ "_before/" + str(i) + "_rad.dat")
        rad2 = HD_2[1]
        rad_2 = (rad2 / (ORG_wav1**2)) * 1e-7

        HD_3 = np.loadtxt("/Users/nyonn/Desktop/pythoncode/Dust/SH/data-altitude/output/DD" +str(loop)+ "_after/" + str(i) + "_rad.dat")
        rad3 = HD_3[1]
...
for loop in range(0, 3, 2):
    # 2 μmの暫定的な結果を出力するためのプログラム
    ORG_base = np.loadtxt("/Users/nyonn/Desktop/pythoncode/Dust/SH/data-altitude/output/ORG/ORG_DD" +str(loop)+ "_rad.dat")
    ORG_wave = ORG_base[0]
    ...
    # Baseの高度をここに入れる
    HD_base = np.loadtxt("/Users/nyonn/Desktop/pythoncode/Dust/SH/data-altitude/input_hc/" +str(loop+1)+ "dd.hc")
    altitude = HD_base[:,0]
    orginal = HD_base[:,1]
...
# 2.7 μmのプロット
for loop_num in range(0, 3, 1):
    loop = list_number[loop_num]
    ORG_base = np.loadtxt("/Users/nyonn/Desktop/pythoncode/Dust/SH/output/ORG/ORG_D" +str(loop)+ "_rad.dat")
    ORG_wave = ORG_base[0]
    ORG_wav = 1 / ORG_wave
    ORG_wave = (1 / ORG_wave) * 10000
